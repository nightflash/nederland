...
По состоянию на 04.08.2025 есть проблема с выбором СССР как страны рождения:
* **выбирайте Россию, распечатанную анкету исправят на месте**
* либо выполните сложный трюк с установкой системного времени на компьютере

### Трюк с временем для заполнения анкеты

* В момент заполнения страны рождения поменять системное время устройства на 93 год (по их мнению СССР просуществовал до 22 декабря 1993 кода)
* Перейдите на предыдущий пункт (1), потом вернитесь на раздел (2)
* Поставьте страну рождения `Former USSR`
* Продолжайте заполнять анкету до раздела `reasons of visit`
* На нем поменяйте системное время обратно на текущее, сайт вас разлогинит
* Авторизуйтесь снова, заполняйте с места, где остановились.
