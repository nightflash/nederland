...
Есть случаи, когда людям отказывают в визах, предположительно из-за работы в компаниях, находящихся под санкциями (Сбер, Альфа-Банк, Газпром и т. д.) — **актуальный список таких компаний можно посмотреть здесь**:  
https://www.sanctionsmap.eu/api/v1/pdf/regime?id%5B%5D=26&include%5B%5D=lists&lang=en

Также отказы возможны, если человек **сам находится под персональными санкциями**:  
...
* Можно сделать сопроводительное письмо в свободной форме **на английском языке** для пограничника.
