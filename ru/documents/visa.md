---
description: Пошаговое оформление визы в Нидерланды для родственников из России — приглашение, спонсорство, страховка и подача документов.
---
...
Есть случаи, когда людям отказывают в визах, предположительно из-за работы в компаниях, находящихся под санкциями — [узнать больше](./visa-sanctions.md).
...
* Копия [приглашения](#спонсорское-письмо-в-обиходе-приглашение) — ее заберут в ВЦ, а оригинал вернут
...
Базовые документы:
* Загранпаспорт
* Копия предыдущего загранпаспорта, если в нем есть шенгенские визы не старше 3-5 лет
...
Для пенсионеров:
* Песнионное удостоверение (если есть, его не выдают с 2015 года)
...
* Справка из банка о движении средств одного из родителей
* Документы о трудоустройстве одного из родителей
* Спонсорское письмо в свободной форме **на английском языке** от одного из родителей о финансировании поездки
...
> **Важно:** Для любого вида приглашения длительность лучше указывать **не более 90 дней**, иначе возможны проблемы при прохождении границы.

Есть 2 способа сделать это письмо:
1. Полностью онлайн — на сайте **любой** хементы (даже не своей) через DigiD. Я рекомендую [Amstelveen за 20 евро](https://www.amstelveen.nl/regelen-aanvragen/product/identiteitsbewijs-rijbewijs-en-uittreksel_uittreksels-en-registers_bezoek-uit-het-buitenland-ontvangen).
   ...
   **Даты, указанные в онлайн приглашении, значения не имеют, они будут превращены в продолжительность!**
...
**Важно: у настоящего Визового центра только один сайт:** [https://visa.vfsglobal.com/rus/ru/nld](https://visa.vfsglobal.com/rus/ru/nld).

**В 2026 году система записи в ВЦ изменена:**

1. Необходимо дождаться открытия электронной очереди (в Москве и Питере открывается-закрывается с какой-то переодичностью). Используйте [этот телеграм канал](https://t.me/vfs_ru_nl_slots) для отслеживания состояния очереди.
2. [Встать в электронную очередь](https://visa.vfsglobal.com/rus/ru/nld/login)
3. Дождаться e-mail с темой "Slots available for booking an appointment" о том что ваша очередь подошла и вам предложено выбрать слот.
4. **Успеть** выбрать слот используя ссылку из email или [эту](https://visa.vfsglobal.com/rus/ru/nld/login). Перенести слот потом **нельзя**, только отменить.

Есть 2 Telegram источника:

* [группа с обсуждениями](https://t.me/visa_babushek)
* [канал с авто-уведомлениями о состоянии очереди](https://t.me/vfs_ru_nl_slots)

## Виды слотов и платные услуги в ВЦ

> **Важно:** Сделайте все копии документов заранее. В визовом центре копии могут стоить очень дорого: например, в Екатеринбурге брали по 42 рубля за страницу, и на большой семейный пакет это легко выливается в несколько тысяч рублей.
...
Максимальный срок рассмотрения заявки на визу **45 дней**, в исключительных случаях **60 дней** (что является исключительным случаем неизвестно).

Срок доставки зависит от города и региона, для Москвы это пара дней, для более отдаленных мест может достигать недели и больше. 
...
* Рекомендуется взять с собой оригинал или копию приглашения, его могут попросить пограничники в Нидерландах.
* Обязательно иметь при себе обратный билет.
* **Если вы самостоятельно спонсируете поездку, имейте при себе сумму, достаточную на весь срок пребывания по билетам. Пограничник вправе попросить подтвердить наличие этих средств, в том числе показать наличные.**
* На пограничном контроле также могут спросить медицинскую страховку, **она нужна не для оформления визы, а для поездки!**
* Можно сделать сопроводительное письмо в свободной форме **на английском языке** для пограничника, вот [пример такого письма](./visa-border-letter-example.md).
...
* Если билет сквозной, то можно брать вариант с короткой стыковкой (1-3 часа). Даже, в случае, если рейс не успеет, то они бесплатно пересадят на следующий и предоставят отель если рейс долго ждать. 
* Если вы берете отдельные билеты, то лучше брать длинную пересадку (3-4 часа) или ночевать.
