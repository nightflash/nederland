...
Лайфхак: Если купить несколько билетов: одни под поездку, а вторые, например, через полгода (и потом вторые можно сдать), и в сопроводительном письме написать, что вы планируете что человек к вам приедет несколько раз, то фактически у вас появляется повод попросить долгосрочную визу. Проверено - на практике дали визу на год.
