...
Далее нужно записаться на подачу документов в один из [визовых центров](#визовые-центры).

**В 2026 году система записи изменена.**

1. Необходимо дождатся открытия электронной очереди (в Москве и Питере открываеться-закрывается с какой-то переодичностью). Используйте [телеграм бот](https://t.me/vfs_ru_nl_slots) для отслеживания состояния очереди.
...
* [автоматический бот пишет когда открылась/закрылась очередь](https://t.me/vfs_ru_nl_slots)
