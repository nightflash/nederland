...
Есть кейсы, когда в 2025 людям отказывают в визе, предположительно потому, что они работают в компаниях под санкциями (Сбер, Альфа, газпром и т.д) - [полный актуальный список компаний здесь](https://www.sanctionsmap.eu/api/v1/pdf/regime?id%5B%5D=26&include%5B%5D=lists&lang=en) или находятся под [под персональными санкциями](https://www.opensanctions.org). Если в этом списке есть человек с такими же именем и фамилией, как вас (в загран паспорте нет отчества, так что очевидно они его не видят), то возможно стоит проактивно дистанцироваться от него. Например, приложить к заявлению на визу документ, где описать что вы это не он и приложить доказательства. Например, копию паспорта РФ (где видно что у вас разные отчетства) или биографию и фото (в сравнении с страницей на этом ресурсе). DISCLAIMER: Этот путь ещё не пройден. Это лишь предположение. Если попробуете его, пожалуйста потом обновите эту страницу в GitHub чтоб сообщество знало, работает это или нет.   
