...
1. Необходимо дождатся открытия электронной очереди (в Москве и Питере открывается-закрывается с какой-то переодичностью). Используйте [телеграм бот](https://t.me/vfs_ru_nl_slots) для отслеживания состояния очереди.
