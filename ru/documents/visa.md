...
1. Необходимо дождатся открытия электронной очереди (в Москве и Питере открывается-закрывается с какой-то переодичностью). Используйте [этот телеграм канал](https://t.me/vfs_ru_nl_slots) для отслеживания состояния очереди.
...
* [информационный канал с уведомлениями о состоянии очереди](https://t.me/vfs_ru_nl_slots)
